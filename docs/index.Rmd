...
5) We further utilize exploratory data visualizations and descriptive statistics in order to measure video support for election-denying claims between recommendation chains that followed from sources with different political leanings.
